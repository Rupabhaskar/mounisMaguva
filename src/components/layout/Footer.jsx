      ...
      <div className="relative mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 sm:gap-x-8 sm:gap-y-10 lg:grid-cols-12 lg:gap-10">
          <div className="sm:col-span-2 lg:col-span-5">
            <Link
              href="/"
              className="group inline-flex flex-col items-center gap-3 sm:flex-row sm:items-center"
            >
              <Image
                src="/Mounis Logo.png"
                alt={site.name}
                width={96}
                height={96}
                className="size-16 rounded-full object-contain ring-2 ring-white/15 transition-transform group-hover:scale-105 sm:size-20"
              />
            ...
            <p className="mt-3 text-center text-xs uppercase tracking-[0.18em] text-[var(--color-gold)]/90 sm:mt-2 sm:text-left">
              {site.tagline}
            </p>
            <p className="mx-auto mt-4 max-w-md text-center text-sm leading-relaxed text-[var(--color-cream)]/75 sm:mx-0 sm:max-w-sm sm:text-left">
              {site.description}
            </p>
